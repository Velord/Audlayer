...
val filterNotLoopedUI = IntentFilter(ACTION_NOT_LOOP_UI)
val filterSongArtistUI = IntentFilter(ACTION_SONG_ARTIST_UI)
val filterSongNameUI = IntentFilter(ACTION_SONG_NAME_UI)
val filterSongHQUI = IntentFilter(ACTION_SONG_HQ)
val filterSongDurationUI = IntentFilter(ACTION_SONG_DURATION)