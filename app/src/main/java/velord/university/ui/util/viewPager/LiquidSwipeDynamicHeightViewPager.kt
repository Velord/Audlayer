...
import velord.university.ui.util.viewPager.LiquidSwipeDynamicHeightViewPager.LiquidSwipePageTransformer
...
//improved by dynamic height
class LiquidSwipeDynamicHeightViewPager : DynamicHeightViewPager {
        ...
        attrs?.let {
            val typedArray =
                context.obtainStyledAttributes(
                    it,
                    R.styleable.LiquidSwipeViewPager,
                    0,
                    0
                )
            typedArray.apply {
